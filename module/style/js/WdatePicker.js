...
//http://www.my97.net/dp/demo/resource/3.asp#m32
$(function () {
    $.fn.WdatePicker = function (options) {
        var defaults = {
            startDate: '',		                    //起始时间
            onpicked: function (dp) { },            //选择后的事件
            alwaysUseStartDate: false,              //是否一直选用起始时间作为默认值
            dateFmt: 'yyyy-MM-dd HH:mm:ss',         //显示格式
            lang: 'zh-cn',                          //显示语言，支持zh-tw,en
            showIcon: true,                         //是否显示时间标记
            doubleCalendar: true,                  //是否双月历显示
            errDealMode: 0,                         //纠错模式，为0时提示模式，为1时自动纠错模式，为2时标记模式（不提示和更改，只做标记）
            isShowWeek: false,                      //是否显示第几周
            readOnly: false,                        //是否只读
            highLineWeekDay: true,                  //是否高亮显示周末
            isShowClear: true,                      //是否显示清空按钮
            isShowToday: true,                      //是否显示今天按钮
            isShowOK: true,                         //是否显示确定按钮
            position: {},                           //显示的位置
            minDate: '1900-01-01 00:00:00',         //可选择的开始时间
            maxDate: '2099-12-31 23:59:59'          //可选择的结束时间
        };
